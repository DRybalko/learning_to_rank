...
def counterfactual_risk_loss(weights, lagrange_multiplier = 0.9, control_variate = 1):
    """
    Parameters
    ----------
    weights: np.array
    ...
    def compute_loss(y_true, y_pred):
        ...
        return K.mean(weights * y_pred_prob, axis = -1)  + lagrange_multiplier*control_variate

    return compute_loss

def binary_crossentropy_loss(weights, lagrange_multiplier = 0.9, control_variate = 1):
    """
    Parameters
    ----------
    weights: np.array
...
def cnn_model(embed_dim, max_ques_len, max_ans_len, vocab_size, embedding,
    ...
    model.compile(optimizer=adadelta,
                  ...
                  #loss=binary_crossentropy_loss(input_weights)) 
