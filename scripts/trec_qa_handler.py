...
def gen_vocab(data, output_path):
...
def convert_to_npy(data_path, output_path):
    """
    Converts TREC-QA data in xml format to numpy array and stores it on disk.
    ...
    for train in train_files:
        print('Generating npy arrays for', train)
        ...
        vocab = gen_vocab([questions, answers], output_path)
        ...
        for fname in [train, dev, test]:
            ...
            print("[% incorrect, % correct]: ", counts / float(np.sum(counts)))
